...
export default function PianoEditorPdfPage() {
  return (
    <>
...
<button className="flex items-center gap-2 bg-surface-container-high border border-outline-variant px-4 py-1.5 rounded text-sm font-medium text-on-surface hover:bg-surface-bright transition-all mr-2 group"><span className="material-symbols-outlined text-lg group-hover:text-primary transition-colors">picture_as_pdf</span><span>Export as PDF</span></button><button className="flex items-center gap-2 bg-gradient-to-br from-[#C1C1FF] to-[#4A4BDC] px-4 py-1.5 rounded text-sm font-bold text-on-primary-fixed hover:scale-105 hover:shadow-lg hover:shadow-primary/30 transition-all">
                    Export Score
                </button>
...
<button className="p-2 rounded bg-surface-container-highest text-primary hover:scale-110 active:scale-90 transition-all">
...
<button className="p-2 rounded hover:bg-surface-container-high transition-colors text-on-surface-variant hover:scale-110 active:scale-90 transition-all">
...
<div className="w-px h-6 bg-outline-variant/30 mx-1"></div>
<button className="px-3 py-1 text-[10px] font-bold tracking-widest uppercase text-outline hover:scale-110 active:scale-90 transition-all" title="Edit Dynamics">Dynamics</button>
<button className="px-3 py-1 text-[10px] font-bold tracking-widest uppercase text-outline hover:scale-110 active:scale-90 transition-all" title="Edit Articulations">Articulations</button>
</div>
