...
export default function PianoEditorDurationPage() {
  return (
    <>
...
<button className="flex items-center gap-2 bg-surface-container-highest px-4 py-1.5 rounded text-sm hover:bg-surface-bright transition-all shadow-lg shadow-primary/10 border border-primary/20">
<span className="material-symbols-outlined text-primary text-lg">save</span>
<span>Save</span>
</button>
<button className="flex items-center gap-2 bg-surface-container-high border border-outline-variant px-4 py-1.5 rounded text-sm font-medium text-on-surface hover:bg-surface-bright transition-all mr-2 group">
<span className="material-symbols-outlined text-lg group-hover:text-primary transition-colors">picture_as_pdf</span>
<span>Export as PDF</span>
</button>
<button className="flex items-center gap-2 bg-gradient-to-br from-[#C1C1FF] to-[#4A4BDC] px-4 py-1.5 rounded text-sm font-bold text-on-primary-fixed hover:scale-105 hover:shadow-lg hover:shadow-primary/30 transition-all">
                Export Score
            </button>
...
<div className="flex items-center bg-surface-container-low/90 glass-panel rounded-xl px-2 py-1.5 gap-1 border border-white/10 shadow-xl">
<button className="p-2 rounded hover:bg-surface-container-high text-on-surface-variant transition-all hover:scale-110" title="Whole Note">
<span className="note-duration">○</span>
</button>
<button className="p-2 rounded hover:bg-surface-container-high text-on-surface-variant transition-all hover:scale-110" title="Half Note">
<span className="material-symbols-outlined">music_note</span>
</button>
<button className="p-2 rounded bg-surface-container-highest text-primary transition-all hover:scale-110" title="Quarter Note">
<span className="material-symbols-outlined" style={{"fontVariationSettings": "'FILL' 1"}}>music_note</span>
</button>
<button className="p-2 rounded hover:bg-surface-container-high text-on-surface-variant transition-all hover:scale-110" title="Eighth Note">
<span className="material-symbols-outlined">notes</span>
</button>
<button className="p-2 rounded hover:bg-surface-container-high text-on-surface-variant transition-all hover:scale-110" title="Sixteenth Note">
<span className="material-symbols-outlined">format_list_bulleted</span>
</button>
<div className="w-px h-6 bg-outline-variant/30 mx-1"></div>
<button className="p-2 rounded hover:bg-surface-container-high text-on-surface-variant transition-all hover:scale-110" title="Rest">
<span className="material-symbols-outlined">browser_not_supported</span>
</button>
</div>

<div className="flex items-center bg-surface-container-low/80 glass-panel rounded-xl px-2 py-1 gap-1 border border-white/5 shadow-2xl">
<button className="p-1.5 rounded hover:bg-surface-container-high transition-colors text-on-surface-variant hover:scale-110">
<span className="material-symbols-outlined text-xl">turn_sharp_right</span>
</button>
<button className="p-1.5 rounded hover:bg-surface-container-high transition-colors text-on-surface-variant hover:scale-110">
...
<button className="p-1.5 rounded hover:bg-surface-container-high transition-colors text-on-surface-variant hover:scale-110">
<span className="material-symbols-outlined text-xl">line_weight</span>
</button>
<div className="w-px h-5 bg-outline-variant/30 mx-1"></div>
<button className="px-2 py-1 text-[9px] font-bold tracking-widest uppercase text-outline hover:text-on-surface transition-all">Dynamics</button>
<button className="px-2 py-1 text-[9px] font-bold tracking-widest uppercase text-outline hover:text-on-surface transition-all">Articulations</button>
</div>
</div>
...
<div className="mt-4 pt-2 border-t border-dashed border-outline-variant/30 flex items-center gap-12 pl-24 min-h-[40px]">
<input className="bg-transparent border-none text-on-surface-variant font-headline font-medium focus:ring-1 focus:ring-primary/40 rounded px-1 w-12 text-center text-sm" type="text" value="And"/>
<input className="bg-transparent border-none text-on-surface-variant font-headline font-medium focus:ring-1 focus:ring-primary/40 rounded px-1 w-12 text-center text-sm" type="text" value="yet"/>
<input className="bg-transparent border-none text-on-surface-variant font-headline font-medium focus:ring-1 focus:ring-primary/40 rounded px-1 w-12 text-center text-sm" type="text" value="it"/>
<div className="flex-1 text-[10px] text-outline-variant/50 tracking-widest uppercase italic font-bold ml-4">Transcribed Lyrics Track</div>
</div>

<div className="absolute left-[-20px] top-0 h-[calc(100%-40px)] w-2 border-l-2 border-t-2 border-b-2 border-on-surface-variant/30 rounded-l-md"></div>
</div>
</div>
...
<div className="mt-4 pt-2 border-t border-dashed border-outline-variant/30 flex items-center gap-12 pl-24 min-h-[40px]">
<input className="bg-transparent border-none text-on-surface-variant font-headline font-medium focus:ring-1 focus:ring-primary/40 rounded px-1 w-16 text-center text-sm" type="text" value="flows"/>
<input className="bg-transparent border-none text-on-surface-variant font-headline font-medium focus:ring-1 focus:ring-primary/40 rounded px-1 w-20 text-center text-sm" type="text" value="through"/>
<input className="bg-transparent border-none text-outline-variant/30 font-headline font-medium focus:ring-1 focus:ring-primary/40 rounded px-1 w-12 text-center text-sm" placeholder="..." type="text"/>
</div>
<div className="absolute left-[-20px] top-0 h-[calc(100%-40px)] w-2 border-l-2 border-t-2 border-b-2 border-primary/40 rounded-l-md"></div>
</div>
</div>
</div>
</div>
...
<aside className="absolute top-48 right-6 w-72 bg-surface-container-low/90 glass-panel rounded-2xl p-6 shadow-2xl border border-white/5 z-20">
...
<div className="bg-surface-container-lowest p-3 rounded-xl hover:ring-1 hover:ring-primary/50 cursor-text transition-all">
...
<span className="bg-tertiary-container text-on-tertiary-container text-[10px] font-bold px-3 py-1 rounded-full cursor-pointer active:scale-95 transition-transform">Staccato</span>
<span className="bg-surface-container-highest text-on-surface-variant text-[10px] font-bold px-3 py-1 rounded-full hover:bg-surface-variant cursor-pointer transition-colors active:scale-95">Legato</span>
<span className="bg-surface-container-highest text-on-surface-variant text-[10px] font-bold px-3 py-1 rounded-full hover:bg-surface-variant cursor-pointer transition-colors active:scale-95">Tenuto</span>
</div>
</div>
