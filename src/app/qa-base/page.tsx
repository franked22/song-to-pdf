...
export default function QaBasePage() {
  return (
    <>
...
<img alt="User profile" data-alt="professional headshot of a music producer in a dark studio setting with neon highlights" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBbkMf39wGpmvoLQYZBRNrvpl0oPn1HB4q2MI9JyUC3QnDZ_fn6q3q2CahQeuWjtwkh8_alP67KUkJlJSfIoGYFti9mmTcDrN7ikPW-cJuP3_YldcQ8C9idYAPHjByt-4eK6NhxuaH328qEqjE-LSEJ67pBAn8KjSNVb4IY7KDqKfU_B_yKGx_qhBOIEXoB2BmucuvccPVaGUtZudVQxDmpw93-BZYq72zqGubXwl4Z6QPlP39-9MF9o1-dazLemauCzwCuEH8iUg"/>
</div>
</div>
</header>
...
<div className="max-w-4xl w-full bg-surface-container-high/20 rounded-xl p-10 border border-outline-variant/5 shadow-inner">
...
<div className="relative group">
<div className="absolute -left-6 top-1/2 -translate-y-1/2 opacity-0 group-hover:opacity-100 transition-opacity">
<span className="text-[10px] font-bold text-primary">MS. 02</span>
</div>
<div className="flex flex-col gap-[8px] w-full">
<div className="h-px bg-on-surface/20 w-full"></div>
<div className="h-px bg-on-surface/20 w-full"></div>
...
<div className="absolute inset-0 flex items-center px-12 gap-8">
<div className="relative flex flex-col items-center">
<div className="w-4 h-3 bg-secondary rounded-full rotate-[-20deg]"></div>
<div className="w-px h-10 bg-on-surface absolute bottom-2 -right-px"></div>
</div>
<div className="relative flex flex-col items-center">
<div className="w-4 h-3 bg-secondary rounded-full rotate-[-20deg]"></div>
...
<div className="absolute inset-0 flex">
<div className="w-full h-full bg-secondary/5 border-x-2 border-secondary/20"></div>
</div>
</div>
</div>
</div>
...
<div className="absolute bottom-8 left-1/2 -translate-x-1/2 glass-panel border border-white/10 px-8 py-3 rounded-full flex items-center gap-8 shadow-2xl">
<div className="flex items-center gap-4">
...
<div className="bg-surface-container-high p-4 rounded-xl border-l-4 border-tertiary">
...
<button className="flex-1 bg-surface-container-lowest hover:bg-surface-bright py-2 rounded text-[10px] font-bold uppercase transition-colors">Dismiss</button>
...
<div className="bg-surface-container-highest/30 p-3 rounded-lg flex flex-col items-center justify-center text-center">
...
<img alt="Global waveform map" className="w-full h-full object-cover" data-alt="a digital audio waveform graphic with peaks and valleys in shades of indigo and teal on a dark background" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDQJVROxYh3EMiWAkuINESbiX1_ndrQ4OaB9Rd3hmUr5gvDs7EfwuhEKRvIQYhYm8VVey4YOoPm68rjDfGOar0VZkeJkwrTpuzYlMNf5AENmjPhDPSbGEni_RrxXKOkwpyEhAjvIbP0YnsIm5DZBUzE3EJMX_WlXaIgqFDhZurRsPsPSHsPFyR-35wpKWTytUHyWCIlGUmIKiLm0pMlJ-Z64mD7__bWzQMmNF5T-kDPuWM2hAbLlYi4qLCicQT9fWZsAMeIIvbAZQ"/>
