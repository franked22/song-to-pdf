...
<button className="flex items-center gap-2 px-4 py-2 bg-surface-container-highest text-primary rounded-lg text-sm font-medium hover:bg-surface-bright transition-colors"><span className="material-symbols-outlined text-xs">edit</span>
<span className="material-symbols-outlined text-lg">swap_horiz</span>
                        Transpose
                    </button>
<button className="flex items-center gap-2 px-4 py-2 bg-primary-container text-on-primary-container rounded-lg text-sm font-bold hover:opacity-90 transition-all shadow-lg shadow-primary/10"><span className="material-symbols-outlined text-xs">edit</span>
