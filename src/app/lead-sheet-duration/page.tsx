...
export default function LeadSheetDurationPage() {
  return (
    <>
...
<span className="material-symbols-outlined text-sm">picture_as_pdf</span>
                Export as PDF
            </button><button className="bg-gradient-to-br from-[#C1C1FF] to-[#4A4BDC] text-on-primary-container px-4 py-1.5 rounded-md text-sm font-bold hover:opacity-90 transition-all active:scale-95">
                Export Score
            </button>
</div>
</header>
...
<div className="mb-8 flex items-center gap-2 bg-surface-container-high/50 p-2 rounded-xl w-fit">
<button className="p-2 hover:bg-surface-bright rounded-lg text-primary transition-colors flex flex-col items-center gap-1">
<div className="w-2.5 h-1.5 bg-current rounded-full rotate-[-20deg]"></div>
<div className="w-0.5 h-4 bg-current"></div>
<span className="text-[8px] font-bold">1/4</span>
</button>
<button className="p-2 bg-primary/20 text-primary rounded-lg border border-primary/30 flex flex-col items-center gap-1">
<div className="w-2.5 h-1.5 bg-current rounded-full rotate-[-20deg]"></div>
<div className="w-0.5 h-4 bg-current"></div>
<div className="w-2 h-0.5 bg-current -mt-0.5 ml-1.5 rotate-[20deg]"></div>
<span className="text-[8px] font-bold">1/8</span>
</button>
<button className="p-2 hover:bg-surface-bright rounded-lg text-outline transition-colors flex flex-col items-center gap-1">
<div className="w-3 h-2 border-2 border-current rounded-full rotate-[-20deg]"></div>
<div className="w-0.5 h-4 bg-current"></div>
...
<button className="p-2 hover:bg-surface-bright rounded-lg text-outline transition-colors">
...
<div className="chord-symbol left-0 cursor-pointer hover:bg-primary/10 rounded px-1 -ml-1 transition-colors border-b border-dashed border-primary/30" title="Click to edit chord">Cmaj7</div>
<div className="chord-symbol left-1/4 cursor-pointer hover:bg-primary/10 rounded px-1 -ml-1 transition-colors border-b border-dashed border-primary/30" title="Click to edit chord">Am9</div>
<div className="chord-symbol left-1/2 cursor-pointer hover:bg-primary/10 rounded px-1 -ml-1 transition-colors border-b border-dashed border-primary/30" title="Click to edit chord">Dm11</div>
<div className="chord-symbol left-3/4 cursor-pointer hover:bg-primary/10 rounded px-1 -ml-1 transition-colors border-b border-dashed border-primary/30" title="Click to edit chord">G7<span className="text-xs align-top text-tertiary">alt</span></div>
...
<div className="lyric-text left-[78%] font-bold">Tok-</div>
...
<div className="absolute top-[3.75rem] left-[5%] w-3 h-2 bg-on-surface rounded-full rotate-[-20deg] cursor-pointer hover:scale-125 hover:shadow-[0_0_10px_rgba(255,255,255,0.5)] transition-all" title="Drag to move or click to edit note"></div>
<div className="absolute top-[3.25rem] left-[15%] w-3 h-2 bg-on-surface rounded-full rotate-[-20deg] cursor-pointer hover:scale-125 hover:shadow-[0_0_10px_rgba(255,255,255,0.5)] transition-all" title="Drag to move or click to edit note"></div>
<div className="absolute top-[2.75rem] left-[25%] w-3 h-2 bg-on-surface rounded-full rotate-[-20deg] cursor-pointer hover:scale-125 hover:shadow-[0_0_10px_rgba(255,255,255,0.5)] transition-all" title="Drag to move or click to edit note"></div>
<div className="absolute top-[4.25rem] left-[40%] w-3 h-2 bg-on-surface rounded-full rotate-[-20deg] cursor-pointer hover:scale-125 hover:shadow-[0_0_10px_rgba(255,255,255,0.5)] transition-all" title="Drag to move or click to edit note"></div>
...
<div className="staff-container border-l-2 border-on-surface-variant/30 pl-4 relative">
<div className="chord-symbol left-0 cursor-pointer hover:bg-primary/10 rounded px-1 -ml-1 transition-colors border-b border-dashed border-primary/30" title="Click to edit chord">Fmaj9</div>
<div className="chord-symbol left-1/4 cursor-pointer hover:bg-primary/10 rounded px-1 -ml-1 transition-colors border-b border-dashed border-primary/30" title="Click to edit chord">E7<span className="text-xs align-top text-tertiary">b13</span></div>
<div className="chord-symbol left-1/2 cursor-pointer hover:bg-primary/10 rounded px-1 -ml-1 transition-colors border-b border-dashed border-primary/30" title="Click to edit chord">Am7</div>
<div className="chord-symbol left-3/4 cursor-pointer hover:bg-primary/10 rounded px-1 -ml-1 transition-colors border-b border-dashed border-primary/30" title="Click to edit chord">Gm7 <span className="text-sm font-medium text-outline">C7</span></div>

<div className="lyric-text left-[2%]">yo</div>
<div className="lyric-text left-[26%] italic">neon</div>
<div className="lyric-text left-[51%]">lights</div>
<div className="lyric-text left-[76%] text-secondary">glow-</div>
<div className="notation-line"></div>
<div className="notation-line"></div>
<div className="notation-line"></div>
<div className="notation-line"></div>
...
<div className="staff-container border-l-2 border-on-surface-variant/30 pl-4 relative">
<div className="chord-symbol left-0 cursor-pointer hover:bg-primary/10 rounded px-1 -ml-1 transition-colors border-b border-dashed border-primary/30" title="Click to edit chord">Bbmaj7</div>
<div className="chord-symbol left-1/2 cursor-pointer hover:bg-primary/10 rounded px-1 -ml-1 transition-colors border-b border-dashed border-primary/30" title="Click to edit chord">Bdim7</div>

<div className="lyric-text left-[2%]">ing...</div>
<div className="notation-line"></div>
<div className="notation-line"></div>
<div className="notation-line"></div>
<div className="notation-line"></div>
